...
public class FilterMoreResultsByPropertyType extends TestBase{
	...
	public void filterResultsByPropertyTypeLand (String searchkeyword) throws IOException, InterruptedException
	{
		...
		filtermoreresultspg.uncheckAllPropertyType(driver);
		filtermoreresultspg.filterByPropertyTypeLand(driver);
		filtermoreresultspg.applyMoreFilters(driver);
		String diditfilter = filtermoreresultspg.verifyFilterByPropertyTypeLand(driver);
