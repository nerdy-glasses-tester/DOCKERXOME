...
public class ExcelMethods {
	...
	public static final String FILE_NAME = basePath+"/TestData.xlsx";
	public static final String MOBILE_FILE_NAME = basePath+"/src/main/resources/MobileTestData.xlsx";
