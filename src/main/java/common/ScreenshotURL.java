...
public class ScreenshotURL extends TestBase{
	...
	public static void screenshotURL (RemoteWebDriver driver, String foldername, String errorname)  throws IOException 
	{		
        ...
        //driver = (RemoteWebDriver) new Augmenter().augment(driver); (No longer needed. Only used in 2012)
	...
	public static void backupCopyScreenshot (RemoteWebDriver driver, String foldername, String picinfo)  throws IOException 
	{		
        //driver = (RemoteWebDriver) new Augmenter().augment(driver); (This is no longer needed. Only use in 2012)
